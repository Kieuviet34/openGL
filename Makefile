...
CUSTOM_SRC = object/skybox.cpp stb_image_loader.cpp object/grass.cpp object/ground.cpp object/light.cpp terrain/terrain.cpp object/water.cpp terrain/lodterrain.cpp
all:
